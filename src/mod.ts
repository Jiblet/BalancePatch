...
class Mod implements IPostDBLoadMod {
	//private config = require("..//config.json"); //this grabs our config file I think


	public postDBLoad(container: DependencyContainer): void {
		const Logger = container.resolve<ILogger>("WinstonLogger");

		Logger.info("Loading Jiblet's Balance Patch");
		// get database from server, a la chomp
		...
		if (config.optics) {
			...
			//Assault Scopes 
			{
				...
				items["57aca93d2459771f2c7e26db"]._props.Ergonomics = modErgo,
					...
					//ELCAN Specter OS4x assault scope (OS4x)
					items["544a3f024bdc2d1d388b4568"]._props.Ergonomics = modErgo,

					//SwampFox Trihawk Prism Scope 3x30 (Trihawk 3x30)
					items["626bb8532c923541184624b4"]._props.Ergonomics = modErgo,
			...
			//Collimators
			{
				...
				items["6113d6c3290d254f5e6b27db"]._props.Ergonomics = modErgo,
					...
					items["6165ac8c290d254f5e6b2f6c"]._props.Ergonomics = modErgo
			}
			...
			//Compact Collimators
			{
				...
				items["609b9e31506cf869cf3eaf41"]._props.Ergonomics = modErgo,
					...
					//Aimpoint ACRO P-1 reflex sight (ACRO P-1)
					items["616442e4faa1272e43152193"]._props.Ergonomics = modErgo,

					//Aimpoint Micro T-1 reflex sight
					items["58d399e486f77442e0016fe7"]._props.Ergonomics = modErgo,

					//Aimpoint Micro H-2 reflex sight (H-2)
					items["61657230d92c473c770213d7"]._props.Ergonomics = modErgo,
			...
			//Optics
			{
				//30mm
				{
					...
					items["618ba27d9008e4636a67f61d"]._props.Ergonomics = modErgo,
						...
						//Nightforce NXS 2.5-10x24 scope (NXS 2.5-10)
						items["544a3d0a4bdc2d1b388b4567"]._props.Ergonomics = modErgo,

						//Optical scope March Tactical 3-24x42 FFP
						items["57c5ac0824597754771e88a9"]._props.Ergonomics = modErgo,

						//PU 3.5x riflescope - I know, I know, not a 30mm optic but a 21mm. But it definitely shouldnt be -5 ergo
						items["5b3f7c1c5acfc40dc5296b1d"]._props.Ergonomics = modErgo
				}
				...
				//PSO
				{
					let modErgo = "-2"; //the sum when u use the eyecup
			...
			//Special Sights
			{
				let modErgo = "-4"; //the REAP-IR is -4 when u use the eyecup, so fuck it, the other ones are the same now
			...
			//Mounts
			{
				...
				items["5b3b6dc75acfc47a8773fb1e"]._props.Ergonomics = modErgo,
					...
					items["5b31163c5acfc400153b71cb"]._props.Ergonomics = modErgo,

					//Mosin Rifle Kochetov mount
					items["5b3f7bf05acfc433000ecf6b"]._props.Ergonomics = modErgo
				...
				//Geissele Super Precision mount and ring caps - I want them to combine to = 0 rather than +1 else why use any other mount
				{
					...
					items["618b9643526131765025ab35"]._props.Ergonomics = modErgo,
						//Geissele Super Precision 30mm ring scope mount (DDC)
						items["618bab21526131765025ab3f"]._props.Ergonomics = modErgo
				}
			}
		...
		if (config.pistolGrips) {
			...
			//pistol grips 
			{
				//AR-15 grips 10 / 12 / 15. 
				{
					...
					{
						let modErgo = "10";
						//Tactical Dynamics Hexgrip pistol grip
						items["5c6d7b3d2e221600114c9b7d"]._props.Ergonomics = modErgo,
							...
							items["6193dcd0f8ee7e52e4210a28"]._props.Ergonomics = modErgo,
					...
					//Intermediate - 12
					{
						...
						items["5a339805c4a2826c6e06d73d"]._props.Ergonomics = modErgo,
							...
							//HK V2 pistol grip for AR-15 based systems
							items["5c6d7b3d2e221600114c9b7d"]._props.Ergonomics = modErgo,
				...
				//Kalashnikov Grips	10 / 12 / 14
				{
					...
					//Intermediate
					{
						...
						items["5beec8ea0db834001a6f9dbf"]._props.Ergonomics = modErgo,
							...
							//AK FAB Defense AGR-47 pistol grip (AGR47)
							items["623c3be0484b5003161840dc"]._props.Ergonomics = modErgo,
		...
		if (config.furniture) {
			...
			//Handguards
			{
				...
				//HK-416 Compatible
				{
					...
					//kinda bad
					{
						...
						items["5bb20de5d4351e0035629e59"]._props.Recoil = "-1",
							items["5bb20de5d4351e0035629e59"]._props.Ergonomics = "8"
					}
					//good ergo
					{
				...
				//HK-G36 Compatible
				{
					//HK G36 2-vent handguard (G36 2-vent)
					items["62386b2adf47d66e835094b2"]._props.Recoil = "-4",
						items["62386b2adf47d66e835094b2"]._props.Ergonomics = "22",

						//HK G36 4-vent handguard (G36 4-vent)
						items["62386b7153757417e93a4e9f"]._props.Recoil = "-5",
						items["62386b7153757417e93a4e9f"]._props.Ergonomics = "19",

						//HK G36 6-vent handguard (G36 6-vent)
						items["6231654c71b5bc3baa1078e5"]._props.Recoil = "-7",
						items["6231654c71b5bc3baa1078e5"]._props.Ergonomics = "7",

						//HK G36 bipod (G36 bipod)
						//items["622b397c9a3d4327e41843b6"]._props.Recoil = "-4",
						//items["622b397c9a3d4327e41843b6"]._props.Ergonomics = "15",

						//HK G36 hand stop (G36 HS)
						items["622f16a1a5958f63c67f1737"]._props.Ergonomics = "0"
				...
				//AK Compatible
				{
					...
					// outliers: these look better than they are. So. Be chill.
					{
						...
						items["5d2c829448f0353a5c7d6674"]._props.Recoil = "-4",
							...
							items["5f6331e097199b7db2128dc2"]._props.Ergonomics = "8"
					}
				}
			}
		}
		...
		if (config.stocks) {
...

			{
				//AKs
				{
					...
					items["5e217ba4c1434648c13568cd"]._props.Recoil = "-35",
						items["5e217ba4c1434648c13568cd"]._props.Ergonomics = "23",

						//Armacon Baskak stock (Baskak)
						items["57ade1442459771557167e15"]._props.Recoil = "-37",
						items["57ade1442459771557167e15"]._props.Ergonomics = "12",

						//AK Zenit PT-3 "Klassika" stock (PT-3)	
						items["59ecc3dd86f7746dc827481c"]._props.Recoil = "-40",
						items["59ecc3dd86f7746dc827481c"]._props.Ergonomics = "17",
				...
				//G-36
				{
					//HK G36 polymer stock (G36)
					items["622f140da5958f63c67f1735"]._props.Recoil = "-35",
						items["622f140da5958f63c67f1735"]._props.Ergonomics = "23",

						//HK G36 KV adjustable stock (G36 KV)		
						items["622f14e899892a7f9e08f6c5"]._props.Recoil = "-38",
						items["622f14e899892a7f9e08f6c5"]._props.Ergonomics = "11"
				}
				//Vector
				{
				...
				//AR-15 Compatible
				{
					//Buffer Tube Replacements:
					{
						...
						//SI Viper Mod.1 Stock - a little better than the super ergo stuff. OH, equal to HERA CQR I guess? But not really.
						items["627254cc9c563e6e442c398f"]._props.Recoil = "-33",
							items["627254cc9c563e6e442c398f"]._props.Ergonomics = "25",
					...
					//compatible with SI Advanced receiver extension buffer tube (anodized red) - (4 recoil / 2 ergo)
					{
						...
						//Kinda Bad:
						{
							...
							items["606587d11246154cad35d635"]._props.Recoil = "-29",
								...
								items["55d4ae6c4bdc2d8b2f8b456e"]._props.Ergonomics = "7",

								//HK Slim Line Stock
								items["5bb20e70d4351e0035629f8f"]._props.Recoil = "-32",
								items["5bb20e70d4351e0035629f8f"]._props.Ergonomics = "5",

								//Izhmash AK-12 regular stock
								items["5beec8c20db834001d2c465c"]._props.Recoil = "-29",
								items["5beec8c20db834001d2c465c"]._props.Ergonomics = "7",
						...
						//Super Ergo - like, silly ergo. 5 options, 1 fde
						{
							...
							items["602e620f9b513876d4338d9a"]._props.Recoil = "-30",
								...
								//SB Tactical SBA3 buttstock (SBA3)
								items["628a85ee6b1d481ff772e9d5"]._props.Recoil = "-30",
								items["628a85ee6b1d481ff772e9d5"]._props.Ergonomics = "19",

								//SI Viper Mod.1 Stock
								items["5c793fde2e221601da358614"]._props.Recoil = "-30",
								items["5c793fde2e221601da358614"]._props.Ergonomics = "19",

								//Fab Defence GLR-16-S Stock
								items["5bfe86df0db834001b734685"]._props.Recoil = "-30",
								items["5bfe86df0db834001b734685"]._props.Ergonomics = "19",

								//Fab Defence GL Shock Stock
								items["5a9eb32da2750c00171b3f9c"]._props.Recoil = "-30",
								items["5a9eb32da2750c00171b3f9c"]._props.Ergonomics = "19"
						}
						...
						//"Balanced" parts - 1 pt less recoil than MOE, 4 more ergo. - 6 options, 2 fde
						{
							...
							items["5b39f8db5acfc40016387a1b"]._props.Recoil = "-32",
								...
								//LMT Sopmod stock
								items["5ae30c9a5acfc408fb139a03"]._props.Recoil = "-32",
								items["5ae30c9a5acfc408fb139a03"]._props.Ergonomics = "14"
						}
				...
				//MCX/MPX stocks
				{
					...
					items["5894a13e86f7742405482982"]._props.Recoil = "-32",
						items["5894a13e86f7742405482982"]._props.Ergonomics = "28",

						//Maxim Defence CQB collapsing/telescoping MCX/MPX stock
						items["5c5db6ee2e221600113fba54"]._props.Recoil = "-34",
						items["5c5db6ee2e221600113fba54"]._props.Ergonomics = "21",

						//PMM "ULSS" foldable MCX/MPX stock
						items["5c5db6f82e2216003a0fe914"]._props.Recoil = "-36",
						items["5c5db6f82e2216003a0fe914"]._props.Ergonomics = "16",

						//SIG Sauer Thin lightweight MCX/MPX stock
						items["5fbcc437d724d907e2077d5c"]._props.Recoil = "-39", // MESA + PRS - a little silly, but might as well have one for sniping.
						items["5fbcc437d724d907e2077d5c"]._props.Ergonomics = "4",

						//SIG Sauer telescoping MCX/MPX stock
						items["5fbcc429900b1d5091531dd7"]._props.Recoil = "-37", // cloning the  Magpul MOE stock	
						items["5fbcc429900b1d5091531dd7"]._props.Ergonomics = "12" //default stock should be pretty balanced.
...

			{
				...
				//midErgo -2/+10
				{
					...
					items["5c87ca002e221600114cb150"]._props.Recoil = modRecoil,
						...
						items["5de8fbad2fbe23140d3ee9c4"]._props.Recoil = modRecoil,
						items["5de8fbad2fbe23140d3ee9c4"]._props.Ergonomics = modErgo,
						...
						items["5df36948bb49d91fb446d5ad"]._props.Recoil = modRecoil,
						items["5df36948bb49d91fb446d5ad"]._props.Ergonomics = modErgo
				}
				//LowErgo -3/+6
				{
			...
			//5.56 compatable
			{
				...
				//Muzzle Brakes
				{
					...
					items["618407a850224f204c1da549"]._props.Recoil = "-18",
						...
						//AR-15 Yankee Hill Phantom 5.56x45 flash hider (Phantom)
						items["626a74340be03179a165e30c"]._props.Recoil = "-18",
						items["626a74340be03179a165e30c"]._props.Ergonomics = "0",
						...
						//KAC QDC 5.56x45 3-Prong Flash Eliminator (QDC-3 556)
						items["626667e87379c44d557b7550"]._props.Recoil = "-20",
						items["626667e87379c44d557b7550"]._props.Ergonomics = "-2",
				...
				//Silencers
				{
					...
					items["60926df0132d4d12c81fd9df"]._props.Recoil = "-4",
						...
						//KAC QDC 5.56x45 sound suppressor (QDC 556)
						items["626673016f1edc06f30cf6d5"]._props.Recoil = "-4",
						items["626673016f1edc06f30cf6d5"]._props.Ergonomics = "-17",
				...
				//Muzzle Brakes
				{
					//pure muzzle brakes
					{
						...
						items["5b7d693d5acfc43bca706a3d"]._props.Recoil = "-22",
							...
							//AR-10 Dead Air Keymount 7.62x51 muzzle brake (Keymount)
							items["628a66b41d5e41750e314f34"]._props.Recoil = "-20",
							items["628a66b41d5e41750e314f34"]._props.Ergonomics = "-2",
		...
		if (config.tweaks) {
			...
			//Iron Sights - why do some flip up irons have +1 and others don't...? I dont want MBUS sights on *everything*
			{
				...
				//now to buff the uppers :)
				{
					...
					//HK G28 7.62x51 upper receiver (G28)
					items["61713a8fd92c473c770214a4"]._props.Ergonomics += 2;

					//MDR handguard (MDR)
					items["5c48a14f2e2216152006edd7"]._props.Ergonomics += 2;

					//MDR handguard (Black) (MDR Black)
					items["5dcbd6b46ec07c0c4347a564"]._props.Ergonomics += 2;
			...
			//as VAL rebalance
			{
				...
				items["578395e82459774a0e553c7b"]._props.Recoil = "-34", // VSS is supposed to be the very low recoil version
					...
					items["57c450252459772d28133253"]._props.Ergonomics = "24",
			...
			//G-36 Changes
			{
				...
				items["623063e994fc3f7b302a9696"]._props.Ergonomics = "65"
			}
		...
		if (config.compatibility) {
			Logger.info(`Making stuff fit correctly.`);
			//First, a warning. After enabling this setting, disabling it may cause issues.


			//Now for the explanation: Tarkov has a lot of absolutely bizzare parts conflicting or not conflicting in situations they should.
			//The MXC may be the worst offender - it should by default accept ALL .308 muzzle devices, as it uses the same barrel threading as the SR-25.
			//Arrays

			const ArrOf308MuzzleDevices = //if we're being pedantic, the barrel this is based on is the RFB, a 5/8th x 24 muzzle. Same as MCX.
				[
					"612e0d3767085e45ef14057f", // AWC PSR 7.62x51 muzzle brake
					"5f2aa4559b44de6b1b4e68d1", // RFB Flash Hider
					"5b7d693d5acfc43bca706a3d", // AR-10 2A Armanent X3 7.62x51 compensator (X3 762)
					"5a34fd2bc4a282329a73b4c5", // AR-10 AAC Blackout 51T 7.62x51 flash hider (51T 762)
					"6065c6e7132d4d12c81fd8e1", // AR-10 CMMG SV Brake 7.62x51 muzzle brake
					"5d1f819086f7744b355c219b", // AR-10 Daniel Defense WAVE 7.62x51 muzzle brake
					"5dcbe965e4ed22586443a79d", // Desert Tech 7.62x51 flash hider (MDR 762)
					"5d026791d7ad1a04a067ea63", // AR-10 Fortis RED Brake 7.62x51 muzzle brake (RED 762)
					"5dfa3cd1b33c0951220c079b", // AR-10 KAC QDC 7.62x51 flash suppressor kit - THIS FITS THE BLACKOUT ALREADY????
					"6130c43c67085e45ef1405a1", // AR-10 KAC QDC 7.62x51 muzzle brake kit (QDC 762)
					"5cdd7685d7f00c000f260ed2", // AR-10 Keeno Arms SHREWD 7.62x51 muzzle brake
					"5c878e9d2e2216000f201903", // AR-10 Lantac Drakon 7.62x51 muzzle brake-compensator
					"5d02677ad7ad1a04a15c0f95", // AR-10 Nordic Components Corvette 7.62x51 muzzle brake
					"5bbdb8bdd4351e4502011460", // AR-10 Odin Works ATLAS-7 7.62x51 muzzle brake
					"607ffb988900dc2d9a55b6e4", // AR-10 SureFire ProComp 7.62x51 muzzle brake
					"615d8eb350224f204c1da1cf", // AR-10 SureFire Warden 7.62x51 blast regulator - Tarkov Database
					"612e0e3c290d254f5e6b291d", // TAA ZK-38 7.62x51 muzzle brake - Tarkov Database
					"5d443f8fa4b93678dd4a01aa", // AR-10 Thunder Beast Arms 30CB 7.62x51 muzzle brake
					"5c7954d52e221600106f4cc7", // Gemtech ONE direct thread mount adapter
					"5fbc22ccf24b94483f726483", // SIG Sauer Taper-LOK 7.62x51/.300 BLK muzzle adapter (T-LOK) //works on both MCX and all .308?
					"59bffc1f86f77435b128b872", // SilencerCo Hybrid 46 Direct Thread Mount adapter (DT Hybrid)
					"5cf78496d7f00c065703d6ca", // Lantac BMD Blast Mitigation Device A3 direct thread adapter (BMD A3)
					"628a66b41d5e41750e314f34", // AR-10 Dead Air Keymount 7.62x51 muzzle brake (Keymount) (for 5/8 x 24)
					"5fbe7618d6fa9c00c571bb6c"  // SIG Sauer SRD762Ti 7.62x51 sound suppressor (SRD762) //works on both MCX and .308s
				];

			const ArrOf308Barrels =
				[
					"5a34f7f1c4a2826c6e06d75d", // AR-10 7.62x51 18 inch barrel (AR-10 18")
					"5a34fae7c4a2826c6e06d760", // AR-10 7.62x51 22 inch barrel (AR-10 22")
					"5bfebc320db8340019668d79", // M700 7.62x51 20 inch threaded barrel (M700 20")
					"5d2703038abbc3105103d94c", // M700 7.62x51 20 inch stainless steel threaded barrel (M700 20")
					"5df917564a9f347bc92edca3", // SR-25 7.62x51 16 inch barrel (SR-25 16")
					"5dfa397fb11454561e39246c", // SR-25 7.62x51 20 inch barrel (SR-25 20")
					"5fbbfabed5cb881a7363194e", // MCX .300 BLK 171mm barrel (MCX 171mm)
					"5fbbfacda56d053a3543f799", // MCX .300 BLK 229mm barrel (MCX 229mm)
					"60658776f2cb2e02a42ace2b", // Mk47 254mm barrel (Mk47 254mm)
					"6065878ac9cf8012264142fd", // Mk47 409mm barrel (Mk47 409mm)
					"61702be9faa1272e431522c3", // HK417 7.62x51 16.5 inch barrel (417 16.5")
					"618168b350224f204c1da4d8", // FN SCAR-H 7.62x51 13 inch barrel (Mk17 13")
					"6183b0711cb55961fa0fdcad", // FN SCAR-H 7.62x51 16 inch barrel (Mk17 16")
					"6183b084a112697a4b3a6e6c", // FN SCAR-H 7.62x51 20 inch barrel (Mk17 20")
					"5df256570dee1b22f862e9c4", // T-5000M 7.62x51 660mm barrel (T-5000M 660mm
					"5dcbe9431e1f4616d354987e", // MDR 7.62x51 16 inch barrel (MDR 762 16"
					"5addbac75acfc400194dbc56", // M1A 7.62x51 22 inch barrel (M1A 22")
					"5b099a765acfc47a8607efe3", // SA-58 7.62x51 11 inch barrel (SA58 11")
					"5b7be1125acfc4001876c0e5", // SA-58 7.62x51 16 inch barrel (SA58 16"
					"5b7be1265acfc400161d0798", // SA-58 7.62x51 21 inch barrel (SA58 21"
					"5f2aa43ba9b91d26f20ae6d2"  // RFB thread spacer (RFB spacer)
				];

			const ArrOfOmega45Barrels =
				[
					"5c5db5c62e22160012542255", // MPX 9x19 14 inch barrel
					"5c5db5b82e2216003a0fe71d", // MPX 9x19 10.5 inch barrel
					"5894a2c386f77427140b8342", // MPX 9x19 203mm barrel
					"5c5db5962e2216000e5e46eb", // MPX 9x19 6.5 inch barrel
					"5c5db5852e2216003a0fe71a", // MPX 9x19 4.5 inch barrel
					"5fbbc383d5cb881a7363194a", // KRISS Vector 9x19 6 inch barrel
					"5fbbc366ca32ed67276c1557", // KRISS Vector 9x19 5 inch barrel
					"603373004e02ce1eaa358814", // STM-9 9x19 16 inch barrel
					"603372f153a60014f970616d", // STM-9 9x19 14 inch barrel
					"603372d154072b51b239f9e1", // STM-9 9x19 12 inch barrel
					"603372b4da11d6478d5a07ff", // STM-9 9x19 10.5 inch barrel
					"5fbbfabed5cb881a7363194e", // MCX .300 BLK 171mm barrel (MCX 171mm)
					"5fbbfacda56d053a3543f799" // MCX .300 BLK 229mm barrel (MCX 229mm)
				];
			//this adds .308 muzzle devices to every barrel that should be able to accept them.
			for (let BarrelID of ArrOf308Barrels) {
				for (let MuzzleID of ArrOf308MuzzleDevices) {
					if (!items[BarrelID]._props.Slots[0]._props.filters[0].Filter.includes(MuzzleID)) { items[BarrelID]._props.Slots[0]._props.filters[0].Filter.push(MuzzleID); }
					//Fuck please don't break lol.
				}
			}
			//Do Compat Merge:
			//"5fc4b992187fea44d52edaa9" // SilencerCo Omega 45k direct thread mount adapter
			//"59bffc1f86f77435b128b872" // SilencerCo Hybrid 46 Direct Thread Mount adapter
			//This adds the Omega 45 and Hybrid 46 for MCX and anything pistol caliber
			for (let BarrelID of ArrOfOmega45Barrels) {
				if (!items[BarrelID]._props.Slots[0]._props.filters[0].Filter.includes("5fc4b992187fea44d52edaa9")) { items[BarrelID]._props.Slots[0]._props.filters[0].Filter.push("5fc4b992187fea44d52edaa9"); }
				if (!items[BarrelID]._props.Slots[0]._props.filters[0].Filter.includes("59bffc1f86f77435b128b872")) { items[BarrelID]._props.Slots[0]._props.filters[0].Filter.push("59bffc1f86f77435b128b872"); }
			}
